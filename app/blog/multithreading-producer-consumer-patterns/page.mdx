export const metadata = {
  ...
  description:
    'How I used a producer-consumer multithreading pattern for non-blocking file writes with PySpark. A deep dive into DataFrame materialisation, resource management, and avoiding executor contention in distributed data processing.',
  alternates: {
    canonical:
      '/blog/multithreading-producer-consumer-patterns',
  },
}
...
# Multithreading Producer-Consumer Patterns in PySpark
